...
public class Registration {
    ...
    private static final By LOGIN_BUTTON_2 = By.xpath("//button[text()='Войти']");
    ...
    public void clickRegisterButton() {
        new WebDriverWait(driver, 5).until(ExpectedConditions.elementToBeClickable(REGISTRATION_BUTTON)).click();
    }
    ...
    @Step("Login button on main page click")
    public void loginButtonOnMainPageClick() {
        driver.findElement(LOGIN_BUTTON).click();
    }

    @Step("Login button on main page click_2")
    public void loginButtonOnMainPageClick_2() {
        driver.findElement(LOGIN_BUTTON_2).click();
    }
    @Step("Logout user button is displayed")
